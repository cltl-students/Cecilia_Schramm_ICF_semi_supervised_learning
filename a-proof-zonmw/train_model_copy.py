...
def train(
    ...
    # load data
    train_data = pd.read_csv(train_pkl)
    train_data['labels'] = train_data.labels.map(lambda x: literal_eval(x))
...
if __name__ == '__main__':
    ...
    train_pkl = "/mnt/data/Users/A-PROOF/cecilia_k/data/Jenia/train_eb_ap_jenia_all-labels.pkl"
    eval_pkl = ""

    # model stored locally (default) or on HuggingFace (--hf)
    model_name = "/mnt/data/Users/A-PROOF/Cecilia_S/models/jenia/domains"
    #/mnt/data/Users/A-PROOF/Cecilia_S/models/fine_tuned/hq_data1_old2/checkpoint-1342-epoch-1x"
    #
